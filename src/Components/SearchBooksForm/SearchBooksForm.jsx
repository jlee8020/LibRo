...
import styles from './SearchBooksForm.module.css';
import { searchBooksByListData, getAllList } from '../../Services/books-api';
...
class SearchBooksForm extends Component {
  ...
  handleClick = (e, book) => {
    e.preventDefault();
    this.props.handleClickSearchBook(book)
  }

  render() {
    return (
      <div>
        <header className={styles.formHeader}>Search Books</header>
        ...
        </section> <div className={styles.btnFind}>
